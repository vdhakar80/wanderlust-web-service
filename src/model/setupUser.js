...
let userData = [
    { userId: "U1001", name: "Jaby", emailId: "Jaby@gmail.com", contactNo: 9098765432, password: "Jaby@1234", bookings: ["B1001", "B1002"] },
    { userId: "U1002", name: "Achara", emailId: "Achara@gmail.com", contactNo: 6234567890, password: "Achara@1234", bookings: ["B1003"] },
    { userId: "U1003", name: "Vicky Dhakar", emailId: "vicky.dhakar@gmail.com", contactNo: 8818900965, password: "Vicky@123", bookings: [] },
    { userId: "U1004", name: "Mansi Sawaj", emailId: "mansi.sawaj@gmail.com", contactNo: 9876543210, password: "Mansi@123", bookings: [] },
    { userId: "U1005", name: "Shivangi Gupta", emailId: "shivangi.gupta@gmail.com", contactNo: 9876543211, password: "Shivangi@123", bookings: [] },
    { userId: "U1006", name: "Ritu Kumawat", emailId: "ritu.kumawat@gmail.com", contactNo: 9876543212, password: "Ritu@123", bookings: [] }
...
//                         return bookingCollection.insertMany(bookingData).then( ()=> {
...
//                                             return hotdealCollection.deleteMany().then( ()=>{
//                                                 return hotdealCollection.insertMany(hotDealsData).then( (data)=>{
//                                                     if (data) {
//                                                         return "Insertion Successfull"
//                                                     } else {
//                                                         throw new Error("Insertion failed")
